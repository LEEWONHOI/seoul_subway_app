...
import com.example.wonhoi_seoul_subway_info_app.data.api.response.mapper.toArrivalInformation
import com.example.wonhoi_seoul_subway_info_app.data.db.StationDao
import com.example.wonhoi_seoul_subway_info_app.data.db.entity.StationSubwayCrossRefEntity
import com.example.wonhoi_seoul_subway_info_app.data.db.entity.mapper.toStationEntitiy
import com.example.wonhoi_seoul_subway_info_app.data.db.entity.mapper.toStations
...
class StationRepositorylmpl(
    ...
    override val stations: Flow<List<Station>> =
        stationDao.getStationWithSubways()
            ...
            .map {
                it.toStations().sortedByDescending { station -> // sortedByDescending 값을 내린 차순으로 정렬해줌
                    station.isFavorited
                }
            }
